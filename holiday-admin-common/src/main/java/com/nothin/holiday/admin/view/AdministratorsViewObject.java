 ...
 * FileName: AdministratorsViewObject.java
 * Author:   李牧牧
...
public class AdministratorsViewObject extends BaseViewObject<AdministratorsViewObject> {

	private static final long serialVersionUID = -6636592888289658275L;
